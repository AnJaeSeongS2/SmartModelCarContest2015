...
void siu_portA_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[2].R = 0x0601;
             /* User Assigned Signal Name : PA2_DC_B_Ch0  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[3].R = 0x0601;
             /* User Assigned Signal Name : PA3_DC_B_Ch1  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[4].R = 0x0601;
             /* User Assigned Signal Name : PA4_DC_A_Ch2  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[5].R = 0x0601;
             /* User Assigned Signal Name : PA5_DC_A_Ch3  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[15].R = 0x0201;
             /* User Assigned Signal Name : PA15_DC_Enable  */
...
void siu_portB_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[17].R = 0x0101;
             /* User Assigned Signal Name : PB1_PIT_ENCODER_GPIO17  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[20].R = 0x2000;
             /* User Assigned Signal Name : PB4_Camera1_Aout_Input  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[21].R = 0x2000;
             /* User Assigned Signal Name : PB5_Camera2_Aout_Input  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[22].R = 0x2000;
             /* User Assigned Signal Name : PB6_InfraredRay1_Input  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[28].R = 0x0201;
             /* User Assigned Signal Name : PB12_Camera_SI_Output  */
             /*	Selected Function : PB12 O          */
             /*	Output Buffers : Enabled          */
             /*	Input Buffers : Disabled          */
             /*	Output Drain : Disabled           */
             /*	Slew Rate Control : Minimum       */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[29].R = 0x0201;
             /* User Assigned Signal Name : PB13_Camera_CLK_Output  */
...
void siu_portD_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[48].R = 0x2000;
             /* User Assigned Signal Name : PD0_PITENCODER_input  */
...
void siu_portE_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[64].R = 0x0101;
             /* User Assigned Signal Name : S1_CAR_START_SWITCH  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[65].R = 0x0101;
             /* User Assigned Signal Name : PE1_RefraredSensor_Switch  */
...
void siu_portG_init_fnc(void)
{
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[108].R = 0x0201;
             /* User Assigned Signal Name : PG12_Camera2_SI  */
    ...
    /* ----------------------------------------------------------- */
       SIU.PCR[109].R = 0x0201;
             /* User Assigned Signal Name : PG13_Camera2_CLK  */
